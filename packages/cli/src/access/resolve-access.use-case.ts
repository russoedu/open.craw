import { loadAccessConfig } from '@opencraw/core'
 ...
 * `OPENCRAW_ACCESS`) names, with `--access-profile` as its default.
 *
...
export async function resolveAccess (options: CommonOptions): Promise<AccessConfig | undefined> {
  if (options.access === undefined) {
    if (options.accessProfile !== undefined) throw new Error('--access-profile needs an access config: --access <file> or OPENCRAW_ACCESS')
